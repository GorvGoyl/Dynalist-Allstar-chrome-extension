...
function open_allstar_settings_popup(e) {
...
function save_allstar_settings_popup(e) {
    var key = 'side_doc';
    if (e.checked === true) {
        enableFeature_SideDoc();
    } else {
